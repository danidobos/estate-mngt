...
class Issue(TimeStampedModel):
    ...
    title = models.CharField(max_length=255, verbose_name=_('Issue Title'))
    ...
    def notify_assigned_user(self) -> None:
        try:
            ...
            html_email = render_to_string(
                'emails/issue_assignment_notification.html', context=context
            )
            ...
            logger.error(f'Failed to send issue assignment for issue {self.title}: {e}')
